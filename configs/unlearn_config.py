...
parser.add_argument("-weight_path", type=str,
                    default='None/Cifar10/backdoor/baseline.pth',
                    help="Path to pretrained model weights")
parser.add_argument("-hidden_layer_num", type= int,
                    help= "hidden layer number of the linear model for tabular dataset")
parser.add_argument("-save_model", action='store_false', help= "option to save the unlearned model")
...
parser.add_argument("-sample_number", type=int, help= "Noise sampling number", default=20)
parser.add_argument("-min_sigma", type=float, help= "Maximum sigma noise", default=0.05)
parser.add_argument("-max_sigma", type=float, help= "Minimum sigma noise", default=1.0)
parser.add_argument("-batch_size", type=int, help="batch size for dataloader", default=128)
...
parser.add_argument("-unlearning_scenario", type= str, choices= ["sensitive", "backdoor", "bias"],
                    help= "unlearning scenarios configuration", default="backdoor")
